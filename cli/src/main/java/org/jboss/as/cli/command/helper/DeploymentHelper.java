package org.jboss.as.cli.command.helper;
...
public class DeploymentHelper {
    ...
    protected void listDeployments(CliCommandInvocation commandInvocation, boolean l) throws CommandFormatException {
        CommandContext ctx = commandInvocation.getCommandContext();
        if(!l) {
            for(String s : Util.getDeployments(ctx.getModelControllerClient()))
        ...
        commandInvocation.getShell().out().println(table.toString());
